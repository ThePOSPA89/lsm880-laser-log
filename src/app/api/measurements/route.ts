...
export async function POST(request: Request) {
  try {
    ...
    const allKeys = ["405", "440", "445", "458", "488", "514", "561", "633", "640", "790", "458_max", "488_max", "514_max"];
    ...
    const { rows } = await sql<MeasurementRow>`
      INSERT INTO measurements (date, system, operator, objective, power_405, power_440, power_445, power_458, power_488, power_514, power_561, power_633, power_640, power_790, power_458_max, power_488_max, power_514_max, note)
      VALUES (
        ${dateValue},
        ${system},
        ${operator || ""},
        ...
        ${values["440"] ?? values[440] ?? null},
        ${values["445"] ?? values[445] ?? null},
        ...
        ${values["640"] ?? values[640] ?? null},
        ${values["790"] ?? values[790] ?? null},
        ${values["458_max"] ?? null},
        ${values["488_max"] ?? null},
        ${values["514_max"] ?? null},
        ${note || ""}
